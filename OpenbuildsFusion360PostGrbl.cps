...
/*
   ...
   03 Jun 2023 - V1.0.36 : code to recenter arcs with bad radii
      Sep 2023 - V1.0.37 : Tape splitting trial
*/
obversion = 'V1.0.37b2';
...
function onSection()
   ...
   if (forceSplit)    
      { 
      writeComment('Continuing operation, run previous file first');
      forceSplit = false;
      }
   ...
   //var cycleTime = section.getCycleTime();
   //writeComment("Cycle time "+ cycleTime);
